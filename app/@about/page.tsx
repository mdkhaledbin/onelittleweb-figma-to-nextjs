  ...
  return (
    <div className="flex flex-col items-center gap-5 h-full">
      ...
      <div className="relative w-full flex justify-center h-full">
        ...
        {/* Card */}
        <div className="w-full py-10 px-6 border border-[#f5c9d5] rounded-2xl flex items-center justify-center min-h-[160px]">
          <div className="text-[#2a1020]">
            {icon}
          </div>
        </div>
      </div>
      ...
      {/* Label */}
      <p className="text-center mx-auto text-[20px] font-semibold max-w-[65%] text-gray-900 leading-snug whitespace-pre-line">
        {label}
      </p>
    </div>
  );

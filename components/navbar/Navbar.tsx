                ...
                NAV_LINKS.map((link) => (
                  <Link 
                    ...
                    className={clsx(
                      ...
                      activeHref === link.href ? "font-bold text-[#ED3C6A]" : "font-normal text-[#1e1e1e]"
                    )}
                  >
                    {link.label}
                    <span 
              ...
              {NAV_LINKS.map((link) => (
                <Link 
                  ...
                  className={clsx(
                    ...
                    activeHref === link.href ? "font-bold text-[#ED3C6A]" : "font-normal text-[#1e1e1e] hover:text-[#ED3C6A]"
                  )}
                >
                  {link.label}
                </Link>

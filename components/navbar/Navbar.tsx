...
import { useHashSectionOnLoad } from "@/components/hooks/useHashSectionOnLoad";
...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 h-15.5 sm:h-22.25 border-b border-[#f3d7e0] bg-white shadow-[0_4px_62px_0_rgba(250,196,210,0.63)]">

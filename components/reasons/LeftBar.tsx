...
export default function LeftBar() {
    return(
        <div className="w-full lg:w-[457px] flex flex-col mx-auto items-center md:items-start pt-[9px] max-w-4/5 md:max-w-full">

            <div className="flex flex-col gap-[20px] md:gap-[26px]">

              <h1 className="w-full lg:max-w-[416px] font-bold text-3xl md:text-4xl">
                Few Reasons Why you Choose us?
              </h1>

              <div className="flex flex-col gap-[20px] md:gap-[30px] text-sm md:text-base">

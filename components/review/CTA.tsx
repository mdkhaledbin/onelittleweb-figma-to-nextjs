        ...
        <div className="mx-auto flex flex-col items-center rounded-[16px] bg-[#f9fafb] px-6 py-7 text-center sm:px-10">
          <div className="mb-5 flex items-center">
            <div className="relative h-14 w-[120px]">
              ...
              <div className="absolute left-8 top-0 h-14 w-14 rounded-full border-2 border-white bg-[#ed3c6a]">
                <Image src={Avatar2} alt="Avatar2" width={56} height={56} />
              </div>
              <div className="absolute left-[72px] top-2 h-12 w-12 rounded-full border-2 border-white bg-[#fac4d2]">
                <Image src={Avatar3} alt="Avatar3" width={48} height={48} />
              </div>
            </div>
          </div>
          <h2 className="font-semibold text-[24px] leading-[1.2] text-[#101828]">
            {CTA.heading}
          </h2>
          <p className="mt-2 max-w-[620px] text-[14px] leading-6 text-[#191d23]">
            {CTA.description}
          </p>
